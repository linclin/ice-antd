...
import { GetReqApiLog } from '@/services/sys/sys_req_api_log';
import type { SysReqApiLog } from '@/interfaces/sys';
import type { Req } from '@/interfaces/resp';
import { RemoveEmptyKeys } from '@/utils/obj';

const columns: Array<ProColumns<SysReqApiLog>> = [
  {
    title: '请求ID',
    dataIndex: 'RequestId',
  },
